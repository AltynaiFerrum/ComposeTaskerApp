...
import com.jyldyzferr.composetaskerapp.common.extensions.toHexCode
import com.jyldyzferr.composetaskerapp.presentation.components.CustomButton
import com.jyldyzferr.composetaskerapp.presentation.screens.add_screen.AddTaskToolbar
import com.jyldyzferr.composetaskerapp.presentation.theme.ExtraLargeSpacing
    ...
    Column(
        ...
        HarmonyColorPicker(
            ...
            extraColors = color.getColors(colorHarmonyMode = ColorHarmonyMode.SHADES)
                val color = extraColors.firstOrNull()?.toColor() ?: return@HarmonyColorPicker
